"""
Created on Sun Dec 04 01:00:12 2022
...
def load_data():
    ...
    df_agg = pd.read_csv('aggregated-metrics-video.csv').iloc[1:,:]
    ...
    df_agg_sub = pd.read_csv('aggregated-metrics-country-subscriber-status.csv')
    df_comments = pd.read_csv('aggregated-metrics-video.csv')
    df_time = pd.read_csv('video-performance-over-time.csv')
